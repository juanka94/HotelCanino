...
$nombre = array('name' =>'nombre','class' =>'form-control', 'value'=>$servicio['nombre']); 
$precio = array('name' =>'precio','class' =>'form-control', 'value'=>$servicio['precio']); 
$descripcion = array('name' =>'descripcion','class' =>'form-control', 'value'=>$servicio['descripcion']); 
$label= array('name'=>'','class'=>'col-sm-3 control-label');
$submit = array('name' => '','class'=>'btn btn-green btn-block' );
$hidden = array('id' => $servicio['id']);
?>
<div id="page-wrapper">
    ...
    <div class="page-content">
        <div id="tab-general">
            <div class="row mbl">
                ...
                <div class="col-lg-12">
                  <div class="row">
                        <div class="col-md-12"><h2>Modificar un servicio</h2>
                            <div class="row mtl">   
                                <div class="col-md-9">
                                    <div id="generalTabContent" class="tab-content">
                                        <div id="tab-edit" class="tab-pane fade in active">
                                            <?= (form_open('administradores/modificar_servicio',$form, $hidden)); ?>
                                               <h3>servicio</h3>
