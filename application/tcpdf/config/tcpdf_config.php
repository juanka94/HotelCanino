 ...
 */
define ('K_PATH_URL', 'http://localhost/hotelcaninoreyes/');
 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', K_PATH_URL.'assets/PDF/');
 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Hotel Canino Reyes');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Hotel Canino Reyes');
 ...
 */
define ('PDF_HEADER_STRING', "Hotel Canino Reyes\nLOS TRATAMOS COMO REYES");
